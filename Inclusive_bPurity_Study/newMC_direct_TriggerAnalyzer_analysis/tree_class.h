...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nmuon;
   vector<float> *no_04_good_muon_pt;
   vector<float> *no_04_good_muon_eta;
   vector<float> *no_04_good_muon_phi;
   vector<float> *no_04_good_jet_pt;
   vector<float> *no_04_good_jet_eta;
   ...
   TBranch *b_no_04_good_jet_pt;
   TBranch *b_no_04_good_jet_eta;
...
//VB: For genJet analysis
   ...
   fChain->SetBranchAddress("b_no_04_good_muon_pt",&b_no_04_good_muon_pt);
   fChain->SetBranchAddress("b_no_04_good_muon_eta",&b_no_04_good_muon_eta);
   fChain->SetBranchAddress("b_no_04_good_muon_phi",&b_no_04_good_muon_phi);
   fChain->SetBranchAddress("b_no_04_good_jet_pt",&b_no_04_good_jet_pt);
   fChain->SetBranchAddress("b_no_04_good_jet_eta",&b_no_04_good_jet_eta);
   ...
   fChain->SetBranchAddress("cjet_pt",&cjet_pt,&b_cjet_pt);
   fChain->SetBranchAddress("cjet_eta",&cjet_eta,&b_cjet_eta);
   fChain->SetBranchAddress("cjet_phi",&cjet_phi,&b_cjet_phi);
   ...
   fChain->SetBranchAddress("pTb_rel",&pTb_rel,&b_pTq_rel);
   fChain->SetBranchAddress("pTb_rel_dir",&pTb_rel_dir,&b_pTb_rel_dir);
   fChain->SetBranchAddress("pTb_rel_indir",&pTb_rel_indir,&b_pTb_rel_indir);
   fChain->SetBranchAddress("pTc_rel",&pTc_rel,&b_pTc_rel);
   fChain->SetBranchAddress("pTq_rel",&pTq_rel,&b_pTq_rel);
